      ...
      <S.IntroDiv id='intro'>
        <S.IntroUl>
          <S.IntroLi>
            ...
            <div>
              독학을 하다 깊게 배워보고 싶어 웹 개발 부트 캠프 코드 스테이츠를
              수료하였습니다.
            </div>
            <br />
            <div>
            ...
            <div>다른 사람들과 페어 프로그래밍을 할 때마다</div>
            <div>다들 잘 알고 잘하는 걸 느끼고 좌절할 뻔했습니다. </div>
            <div>하지만, 포기 않고 도전하였고 팀원과 협업을 하며 </div>
            <div>적응하고 해결해나가는 저의 모습에 가능성을 보았습니다.</div>
            <br />
            <div>
              아직도 많이 어렵지만 계속 도전하며 문제를 차근차근 해결해 나갈
              때면
            </div>
            <div>너무 재밌기에 계속해서 성장하고 싶습니다.</div>
            <br />
            <div>
              팀원과의 협업과 포기하지 않고 도전하는 걸 가장 중요시하는 개발자가
              되고 싶습니다.
            </div>
          </S.IntroLi>
        </S.IntroUl>
